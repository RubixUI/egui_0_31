use super::{ContrastCurve, DynamicColor, DynamicScheme, ToneDeltaPair, TonePolarity};
...
const fn _is_fidelity(scheme: &DynamicScheme) -> bool {
    matches!(scheme.variant, ColorVariantMode::Fidelity) || matches!(scheme.variant, ColorVariantMode::Content)
}

const fn _is_monochrome(scheme: &DynamicScheme) -> bool {
    matches!(scheme.variant, ColorVariantMode::Monochrome)
}
